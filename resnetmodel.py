...
#not really know what is the difference
...
def omniglot_resnet_v2_generator(block_fn, layers, num_classes, data_format = None):
    """generator for omniglot ResNet v2 models
    Args:
...
def miniImagenet_resnet_v2_generator(block_fn, layers, num_classes, data_format = None):
    ...
    #     # inputs = tf.layers.conv2d(inputs = inputs, filters = 3, kernel_size = 1, kernel_initializer = tf.constant_initializer(1.0), activation = tf.sigmoid)
...
def miniImagenet_resnet_v2(resnet_size, num_classes, data_format = None):
    ...
    return miniImagenet_resnet_v2_generator(params['block'], params['layers'], num_classes, data_format)



def omniglot_resnet_v2(resnet_size, num_classes, data_format = None):
    """
    returns the resnet model for a given size and number of output classes
    """
    ...
    params = model_params[resnet_size]
    return omniglot_resnet_v2_generator(params['blcok'], params['layers'], num_classes, data_format)