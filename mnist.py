...
def cnn_model_fn(features, labels, mode):
  ...
  tf.train.init_from_checkpoint("/tmp/mnist_model/model.ckpt-2000",{'conv1/kernel': 'conv1/kernel',
                                                                    'conv1/bias': 'conv1/bias',
                                                                    'conv2/kernel': 'conv2/kernel',
                                                                    'conv2/bias': 'conv2/bias',
                                                                    'dense1/kernel': 'dense1/kernel',
                                                                    'dense1/bias': 'dense1/bias',
                                                                    'dense2/kernel': 'dense2/kernel',
...
def main(unused_argv):
  ...
  mnist_classifier = tf.estimator.Estimator(
      model_fn=cnn_model_fn, model_dir="/tmp/mnist_model", config = run_config)
